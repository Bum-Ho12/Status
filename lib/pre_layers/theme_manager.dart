...
class ThemeClass {
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(
          color: Color(0xfF25D366), fontSize: 24, fontWeight: FontWeight.w500),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      iconTheme: IconThemeData(color: Color(0xfF128C7E), size: 15),
      actionsIconTheme: IconThemeData(color: Color(0xfF128C7E), size: 35),
      titleTextStyle: TextStyle(
          color: Color(0xfF128C7E), fontSize: 24, fontWeight: FontWeight.w500),
    ),
    hoverColor: const Color(0xff71797E),
    floatingActionButtonTheme: const FloatingActionButtonThemeData(
        hoverElevation: 5, splashColor: Color(0xfF128C7E)),
